...
class SceneDef:
    ...
    def parse(asset, fname):
        return {
            ...
            'filter_bazaar': bool(asset['filterOutOfBazaar']),
            'allow_item_spawn': bool(asset['allowItemsToSpawnObjects']),
            'prevent_stage_advance': bool(asset['preventStageAdvanceCounter']),
            'locked_before_looping': bool(asset['isLockedBeforeLooping']),
            'stage_file': fname,
            'stage_info': None,
            'scene_director': None,
